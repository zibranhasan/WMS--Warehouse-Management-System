...
router.get("/", checkAuth(Role.SUPER_ADMIN, Role.ADMIN, Role.WAREHOUSE_MANAGER), UserController.getAllUsers);
...
router.patch("/:id/warehouse", checkAuth(Role.SUPER_ADMIN, Role.ADMIN), validateRequest(UserValidation.assignWarehouseValidationSchema), UserController.assignWarehouse);
