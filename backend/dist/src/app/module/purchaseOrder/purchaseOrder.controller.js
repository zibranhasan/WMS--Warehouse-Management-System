...
const createPurchaseOrder = catchAsync(async (req, res) => {
    ...
    const result = await PurchaseOrderService.createPurchaseOrder(req.body, userId);
    sendResponse(res, {
...
const getAllPurchaseOrders = catchAsync(async (req, res) => {
    ...
    const result = await PurchaseOrderService.getAllPurchaseOrders(req.query, warehouseScope);
    sendResponse(res, {
...
const updatePurchaseOrder = catchAsync(async (req, res) => {
    ...
    const result = await PurchaseOrderService.updatePurchaseOrder(id, req.body, userRole);
    sendResponse(res, {
        httpStatusCode: httpStatus.OK,
        success: true,
...
const cancelPurchaseOrder = catchAsync(async (req, res) => {
    const id = req.params.id;
    const result = await PurchaseOrderService.cancelPurchaseOrder(id, req.body);
    sendResponse(res, {
        httpStatusCode: httpStatus.OK,
        success: true,
...
const receiveGoods = catchAsync(async (req, res) => {
    const id = req.params.id;
    const userId = req.user.userId;
    const result = await PurchaseOrderService.receiveGoods(id, req.body, userId);
    sendResponse(res, {
        httpStatusCode: httpStatus.OK,
        success: true,
...
const getPurchaseOrderReceipts = catchAsync(async (req, res) => {
    const id = req.params.id;
