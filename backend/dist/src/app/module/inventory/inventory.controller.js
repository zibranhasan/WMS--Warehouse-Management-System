...
// ---------------------------------------------------------------------------
const getStockByWarehouse = catchAsync(async (req, res) => {
    const { warehouseId } = req.params;
    const result = await InventoryService.getStockByWarehouse(warehouseId, req.query);
    sendResponse(res, {
...
// ---------------------------------------------------------------------------
const getProductStock = catchAsync(async (req, res) => {
    const { warehouseId, productId } = req.params;
    const result = await InventoryService.getProductStock(warehouseId, productId);
    sendResponse(res, {
        httpStatusCode: httpStatus.OK,
        success: true,
...
const getInventorySummary = catchAsync(async (req, res) => {
    const { warehouseId, productId } = req.params;
    const result = await InventoryService.getInventorySummary(warehouseId, productId);
    sendResponse(res, {
        httpStatusCode: httpStatus.OK,
        success: true,
...
const getStockMovements = catchAsync(async (req, res) => {
    ...
    const result = await InventoryService.getStockMovements(req.query, warehouseScope);
    sendResponse(res, {
        httpStatusCode: httpStatus.OK,
        success: true,
...
const getProductMovements = catchAsync(async (req, res) => {
    ...
    const warehouseScope = getWarehouseScope(req.user.role, req.user.warehouseId);
    const result = await InventoryService.getProductMovements(productId, req.query, warehouseScope);
    sendResponse(res, {
        httpStatusCode: httpStatus.OK,
        success: true,
        message: "Stock movements fetched successfully.",
...
// ---------------------------------------------------------------------------
const allocateStock = catchAsync(async (req, res) => {
    const userId = req.user.userId;
...
// ---------------------------------------------------------------------------
const deallocateStock = catchAsync(async (req, res) => {
    const userId = req.user.userId;
    const result = await InventoryLocationService.deallocateStock(req.body, userId);
    sendResponse(res, {
        httpStatusCode: httpStatus.OK,
        success: true,
...
// ---------------------------------------------------------------------------
const transferStock = catchAsync(async (req, res) => {
    const userId = req.user.userId;
    const result = await InventoryLocationService.transferStock(req.body, userId);
    sendResponse(res, {
        httpStatusCode: httpStatus.OK,
        success: true,
...
// ---------------------------------------------------------------------------
const getStockByBin = catchAsync(async (req, res) => {
    const { binId } = req.params;
    const result = await InventoryLocationService.getStockByBin(binId);
    sendResponse(res, {
        httpStatusCode: httpStatus.OK,
        success: true,
...
// ---------------------------------------------------------------------------
const getProductLocations = catchAsync(async (req, res) => {
    const { productId } = req.params;
    const warehouseScope = getWarehouseScope(req.user.role, req.user.warehouseId);
    const result = await InventoryLocationService.getProductLocations(productId, warehouseScope);
    sendResponse(res, {
        httpStatusCode: httpStatus.OK,
        success: true,
...
// ---------------------------------------------------------------------------
const getWarehouseLocationStock = catchAsync(async (req, res) => {
    const { warehouseId } = req.params;
    const result = await InventoryLocationService.getWarehouseLocationStock(warehouseId, req.query);
    sendResponse(res, {
        httpStatusCode: httpStatus.OK,
        success: true,
...
// ---------------------------------------------------------------------------
const getLocationMovements = catchAsync(async (req, res) => {
    const warehouseScope = getWarehouseScope(req.user.role, req.user.warehouseId);
    const result = await InventoryLocationService.getLocationMovements(req.query, warehouseScope);
    sendResponse(res, {
        httpStatusCode: httpStatus.OK,
        success: true,
