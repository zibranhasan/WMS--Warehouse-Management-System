...
// ─── Register paths ──────────────────────────────────────────────────
export function registerSalesOrderPaths(registry) {
    registry.registerComponent("schemas", "SalesOrder", SalesOrderResponse);
    registry.registerComponent("schemas", "SalesOrderItem", SalesOrderItemResponse);
    registry.registerComponent("schemas", "StockReservation", StockReservationResponse);
    registry.registerComponent("schemas", "CreateSalesOrderRequest", CreateSalesOrderRequest);
    registry.registerComponent("schemas", "CancelSalesOrderRequest", CancelSalesOrderRequest);
    // ─── CREATE ───────────────────────────────────────────────────────
    ...
    registry.registerPath({
        ...
        description: "Retrieves a single sales order with full details: warehouse, createdBy, items (with product), and reservations. Warehouse access is validated via checkSoWarehouseAccess.",
        security: [{ cookieAuth: [] }],
        request: {
