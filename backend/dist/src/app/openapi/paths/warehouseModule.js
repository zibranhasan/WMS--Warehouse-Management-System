...
export function registerWarehouseModulePaths(registry) {
    registry.registerComponent("schemas", "WarehouseListItem", WarehouseListItem);
    registry.registerComponent("schemas", "CreateWarehouseRequest", CreateWarehouseRequest);
    registry.registerComponent("schemas", "UpdateWarehouseRequest", UpdateWarehouseRequest);
    registry.registerComponent("schemas", "UpdateWarehouseStatusRequest", UpdateWarehouseStatusRequest);
    ...
    registry.registerPath({
        ...
        description: "Retrieves a paginated list of warehouses. All authenticated roles permitted.",
        security: [{ cookieAuth: [] }],
    ...
    registry.registerPath({
        ...
        description: "Retrieves the complete physical structure of a warehouse including nested zones, aisles, shelves, and bins.",
        security: [{ cookieAuth: [] }],
        request: {
            params: z.object({ warehouseId: z.string().describe("Warehouse ID") }),
        },
    ...
    registry.registerPath({
        ...
        description: "Assigns a user to a warehouse. User must be active and not already assigned. Warehouse must be active. Requires SUPER_ADMIN or ADMIN role.",
        security: [{ cookieAuth: [] }],
        request: {
            params: z.object({
