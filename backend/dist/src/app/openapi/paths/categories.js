...
export function registerCategoryPaths(registry) {
    registry.registerComponent("schemas", "CreateCategoryRequest", CreateCategoryRequest);
    registry.registerComponent("schemas", "UpdateCategoryRequest", UpdateCategoryRequest);
    registry.registerComponent("schemas", "UpdateCategoryStatusRequest", UpdateCategoryStatusRequest);
