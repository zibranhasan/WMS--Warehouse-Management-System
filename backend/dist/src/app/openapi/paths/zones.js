...
import { ZoneResponse, AisleResponse } from "../components/schemas";
...
export function registerZonePaths(registry) {
    registry.registerComponent("schemas", "CreateZoneRequest", CreateZoneRequest);
    registry.registerComponent("schemas", "UpdateZoneRequest", UpdateZoneRequest);
    registry.registerComponent("schemas", "UpdateZoneStatusRequest", UpdateZoneStatusRequest);
    registry.registerPath({
        ...
        tags: ["Zones"],
        summary: "Create zone",
        description: "Creates a new zone within a warehouse. Warehouse must be active. Zone code must be unique within the warehouse. Requires SUPER_ADMIN, ADMIN, or WAREHOUSE_MANAGER role.",
        security: [{ cookieAuth: [] }],
        request: {
