...
export function registerSupplierPaths(registry) {
    registry.registerComponent("schemas", "CreateSupplierRequest", CreateSupplierRequest);
    registry.registerComponent("schemas", "UpdateSupplierRequest", UpdateSupplierRequest);
    registry.registerComponent("schemas", "UpdateSupplierStatusRequest", UpdateSupplierStatusRequest);
