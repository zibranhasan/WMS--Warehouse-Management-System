...
export function registerShelfPaths(registry) {
    registry.registerComponent("schemas", "CreateShelfRequest", CreateShelfRequest);
    registry.registerComponent("schemas", "UpdateShelfRequest", UpdateShelfRequest);
    registry.registerComponent("schemas", "UpdateShelfStatusRequest", UpdateShelfStatusRequest);
