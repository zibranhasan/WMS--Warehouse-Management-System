...
import { BinResponse } from "../components/schemas.js";
...
export function registerBinPaths(registry: OpenAPIRegistry) {
    registry.registerComponent("schemas", "CreateBinRequest", CreateBinRequest as never);
    registry.registerComponent("schemas", "UpdateBinRequest", UpdateBinRequest as never);
    registry.registerComponent("schemas", "UpdateBinStatusRequest", UpdateBinStatusRequest as never);
