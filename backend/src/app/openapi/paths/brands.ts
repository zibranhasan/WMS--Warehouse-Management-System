...
import { BrandResponse } from "../components/schemas.js";
...
export function registerBrandPaths(registry: OpenAPIRegistry) {
    registry.registerComponent("schemas", "CreateBrandRequest", CreateBrandRequest as never);
    registry.registerComponent("schemas", "UpdateBrandRequest", UpdateBrandRequest as never);
    registry.registerComponent("schemas", "UpdateBrandStatusRequest", UpdateBrandStatusRequest as never);
