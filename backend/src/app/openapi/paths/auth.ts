...
import { UserProfileResponse } from "../components/schemas.js";
...
export function registerAuthPaths(registry: OpenAPIRegistry) {
    registry.registerComponent("schemas", "LoginRequest", LoginRequest as never);
    registry.registerComponent("schemas", "LoginResponse", LoginResponse as never);
    registry.registerComponent("schemas", "ForgotPasswordRequest", ForgotPasswordRequest as never);
    registry.registerComponent("schemas", "ResetPasswordRequest", ResetPasswordRequest as never);
    registry.registerComponent("schemas", "ChangePasswordRequest", ChangePasswordRequest as never);
    registry.registerComponent("schemas", "SendVerificationOtpRequest", SendVerificationOtpRequest as never);
    registry.registerComponent("schemas", "VerifyEmailRequest", VerifyEmailRequest as never);
    registry.registerComponent("schemas", "UpdateProfileRequest", UpdateProfileRequest as never);
    registry.registerComponent("schemas", "MessageResponse", MessageResponse as never);
    ...
    registry.registerPath({
        ...
        description:
            "Updates the authenticated user's profile. Accepts multipart/form-data with optional image file.",
        security: [{ cookieAuth: [] }],
        request: {
            body: {
                content: {
    ...
    registry.registerPath({
        ...
        description:
            "Sends a password reset OTP to the provided email address. Returns a generic message regardless of whether the account exists.",
        request: {
            body: {
                content: {
                    "application/json": {
    ...
    registry.registerPath({
        ...
        description:
            "Resets the user's password using a valid OTP. Deletes all existing sessions after reset.",
        request: {
            body: {
                content: {
                    "application/json": {
