...
import { AisleResponse, ShelfResponse } from "../components/schemas.js";
...
export function registerAislePaths(registry: OpenAPIRegistry) {
    registry.registerComponent("schemas", "CreateAisleRequest", CreateAisleRequest as never);
    registry.registerComponent("schemas", "UpdateAisleRequest", UpdateAisleRequest as never);
    registry.registerComponent("schemas", "UpdateAisleStatusRequest", UpdateAisleStatusRequest as never);
