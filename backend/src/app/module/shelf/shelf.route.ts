...
import { ShelfValidation } from "./shelf.validation.js";
...
router.post(
    ...
    validateRequest(ShelfValidation.createShelfValidationSchema),
...
router.patch(
    "/:id",
    checkAuth(Role.SUPER_ADMIN, Role.ADMIN, Role.WAREHOUSE_MANAGER),
    validateRequest(ShelfValidation.updateShelfValidationSchema),
...
router.patch(
    "/:id/status",
    checkAuth(Role.SUPER_ADMIN, Role.ADMIN, Role.WAREHOUSE_MANAGER),
    validateRequest(ShelfValidation.updateShelfStatusValidationSchema),
    ShelfController.updateShelfStatus,
);
